...
function Men() {
  ...
  const manuallyAddedProducts = [
    { id: 1, title: 'Printed Resort Shirt',price: 10, thumbnail: './public/products/malemodel4.png'},
    ...
    { id: 4, title: 'Highneck Fullsleeve T-shirt',price: 10, thumbnail: './public/products/malemodel3.png' },
