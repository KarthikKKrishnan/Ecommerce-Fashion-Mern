...
function Accessories() {
  ...
  const manuallyAddedProducts = [
    { id: 1, title: 'Strutt Bib Softshell Pant',price: 10, thumbnail: './public/products/acc1.png'},
    { id: 2, title: 'Slim Fit Single-Breasted Blazer',price: 10, thumbnail: './public/products/acc2.png' },
    { id: 3, title: 'Men Blue Washed Denim Jacket',price: 10, thumbnail: './public/products/acc3.png' },
